...
This Wiki collects **real-world test results** from the The Seed community. Unlike vendor
specifications, these reports show actual compatibility with The Seed's diagnostic features.
...
- [HARDWARE.md](https://github.com/krisarmstrong/seed/blob/main/HARDWARE.md) - Official hardware
  guide
- [HARDWARE_DOCUMENTATION_PLAN.md](https://github.com/krisarmstrong/seed/blob/main/docs/HARDWARE_DOCUMENTATION_PLAN.md) -
  Maintenance procedures
- [Submit Hardware Report](https://github.com/krisarmstrong/seed/issues/new?template=hardware-report.yml) -
  Report your test results
- [GitHub Issues](https://github.com/krisarmstrong/seed/issues?q=label%3Ahardware-report) - Browse
  community reports
...
Driver capabilities vary significantly between kernel versions. Always include your kernel version
(`uname -r`) when reporting.
...
USB adapters may have reduced capabilities due to bus limitations. PCIe/M.2 preferred for
professional use.
...
_(This section will be updated as reports are submitted)_

---

**Last Updated:** 2025-12-14 **Maintained By:** The Seed Community **Report Issues:**
[GitHub Issues](https://github.com/krisarmstrong/seed/issues)
