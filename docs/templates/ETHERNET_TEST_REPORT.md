...
Use this template to document Ethernet NIC testing results. Submit via the [Hardware Report](https://github.com/krisarmstrong/luminetiq/issues/new?template=hardware-report.yml) issue template.

## Hardware Information

**NIC**: [Make and Model]
**Chipset**: [e.g., Intel I350, Realtek RTL8111]
**Form Factor**: [PCIe / USB / Onboard]
...
**Cable Used**: [Cat5e/Cat6/Cat6a, length]
