...
describe('useAuth', () => {
  ...
  it('login sets authenticated state on success', async () => {
    ...
    expect(mockLocalStorage.setItem).toHaveBeenCalledWith('netscope_token', 'new-token');
    expect(mockLocalStorage.setItem).toHaveBeenCalledWith('netscope_username', 'admin');
  });
  ...
  it('logout clears auth state', async () => {
    ...
    expect(mockLocalStorage.removeItem).toHaveBeenCalledWith('netscope_username');
  });
});
