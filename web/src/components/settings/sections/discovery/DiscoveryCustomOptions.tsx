 ...
 */
const PORT_PRESETS: Record<
  PortPreset,
  { tcp: string; udp: string; description: string }
> = {
  common: {
...
export const DiscoveryCustomOptions = memo(function DiscoveryCustomOptions({
  ...
  }, [settings.options?.portScan?.preset]);
    ...
    <div className={cn("border-t border-surface-border", spacing.pad.sm)}>
      ...
      <div className={cn(spacing.margin.top.inline, "stack-sm")}>
        ...
        {settings.options?.portScan?.enabled && (
          ...
          >
            <div>
              ...
              >
                {
                  PORT_PRESETS[settings.options?.portScan?.preset ?? "common"]
                    .description
                }
              </p>
            </div>
            <div>
              ...
              >
                ...
                {(settings.options?.portScan?.preset ?? "common") !==
                  "custom" && (
                  <span className="ml-2 text-text-muted italic">
                    {t(
                      "discovery.portPresetReadOnly",
        ...
        >
          ...
          <p className="caption text-text-muted">
            {t(
              "discovery.performanceTimingDesc",
              "Adjust discovery speed and resource usage"
            )}
          </p>
          <div className={cn("stack-sm", spacing.margin.top.inline)}>
              ...
              <input
                ...
                onChange={(e) =>
                  onSettingsChange((prev) => ({
                    ...
                    timing: {
                      ...prev.timing,
                      probeIntervalMs: parseInt(e.target.value),
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onSettingsChange((prev) => ({
                    ...prev,
                    scanTimeoutMs: parseInt(e.target.value),
                  }))
                }
                className="w-full"
              />
            ...
            <div>
              ...
              >
                ...
                <span className="caption text-text-primary font-medium">
                  {Math.round(
                    (settings.timing?.rescanIntervalMs ?? 600000) / 60000
                  )}
                  m
                </span>
              </div>
                ...
                onChange={(e) =>
                  onSettingsChange((prev) => ({
                    ...
                    timing: {
                      ...prev.timing,
                      probeIntervalMs: prev.timing?.probeIntervalMs ?? 75,
                      rescanIntervalMs: parseInt(e.target.value) * 1000,
                      workers: prev.timing?.workers ?? 50,
                    },
                  }))
                }
                    ...
                    onSettingsChange((prev) => ({
                      ...
                      options: {
                        ...
                        portScan: {
                          ...
                          udpPorts:
                            prev.options?.portScan?.udpPorts ?? "53,161",
                          bannerTimeoutMs: parseInt(e.target.value),
                        },
                      },
                    }))
                  }
