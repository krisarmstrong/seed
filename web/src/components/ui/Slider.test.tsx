...
describe("Slider", () => {
  ...
  it("handles keyboard navigation - PageUp key", () => {
    const onChange = vi.fn();
    render(
      <Slider value={50} onChange={onChange} min={0} max={200} step={10} />
    );
  ...
  it("handles keyboard navigation - PageDown key", () => {
    const onChange = vi.fn();
    render(
      <Slider value={150} onChange={onChange} min={0} max={200} step={10} />
    );
  ...
  it("respects min boundary with PageDown", () => {
    const onChange = vi.fn();
    render(
      <Slider value={20} onChange={onChange} min={0} max={100} step={10} />
    );
  ...
  it("respects max boundary with PageUp", () => {
    const onChange = vi.fn();
    render(
      <Slider value={90} onChange={onChange} min={0} max={100} step={10} />
    );
