    ...
    <div className="space-y-6 max-w-2xl p-6 bg-surface-raised rounded-lg border border-surface-border">
      ...
      <div className="mt-8 p-4 bg-surface-base rounded border border-surface-border">
        ...
        <div className="body-small space-y-1 font-mono">
          <div>
            <span className="text-text-muted">Probe Interval:</span>{" "}
            {probeInterval}ms
          </div>
          <div>
          ...
          <div>
            <span className="text-text-muted">Rescan Interval:</span>{" "}
            {rescanInterval} min
          </div>
          <div>
            <span className="text-text-muted">Banner Timeout:</span>{" "}
            {bannerTimeout}ms
          </div>
        </div>
      </div>
