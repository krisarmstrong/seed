    ...
    data: {
      devices: [
        // 1 router
        {
          ...
          lastSeen: new Date().toISOString(),
          isLocal: true,
          profile: { profiledAt: new Date().toISOString(), deviceType: 'router', deviceIcons: ['router'] },
        },
        // 2 servers
        {
          ip: '192.168.1.10',
          ...
          lastSeen: new Date().toISOString(),
          isLocal: true,
          profile: { profiledAt: new Date().toISOString(), deviceType: 'server', deviceIcons: ['server'] },
        },
        {
          ip: '192.168.1.11',
          ...
          lastSeen: new Date().toISOString(),
          isLocal: true,
          profile: { profiledAt: new Date().toISOString(), deviceType: 'server', deviceIcons: ['database'] },
        },
        // 1 printer
        {
          ip: '192.168.1.20',
          ...
          lastSeen: new Date().toISOString(),
          isLocal: true,
          profile: { profiledAt: new Date().toISOString(), deviceType: 'printer', deviceIcons: ['printer'] },
        },
        // 2 mobile
        {
          ip: '192.168.1.30',
