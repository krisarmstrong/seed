...
test.describe('Network Discovery - Complete Flow', () => {
  ...
  test('should toggle sort direction (ascending/descending)', async ({ page }) => {
    ...
    await expect(page.locator('svg').filter({ hasText: /ChevronUp/i }).first()).toBeVisible();
    ...
    await expect(page.locator('svg').filter({ hasText: /ChevronDown/i }).first()).toBeVisible();
  });
