...
export function FloorSelector({
  ...
  onRenameFloor,
  disabled = false,
}: FloorSelectorProps): React.ReactElement {
  /**
  ...
  const handleStartEdit = (floor: Floor): void => {
  ...
  const handleDelete = async (floorId: string): Promise<void> => {
    if (floors.length <= 1) {
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: spacing.xs }}>
            ...
            <input
              ...
              value={newFloorLevel}
              onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>): void =>
                setNewFloorLevel(Number.parseInt(e.target.value, 10) || 0)
              }
              style={{
                width: '60px',
                padding: spacing.xs,
              ...
              >
                ...
                >
                  ...
                  <input
                    ...
                    value={editLevel}
                    onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>): void =>
                      setEditLevel(Number.parseInt(e.target.value, 10) || 0)
                    }
                    style={{
                      width: '60px',
                      padding: spacing.xs,
            ...
            >
              ...
              >
                {onRenameFloor ? (
                  <button
                    type="button"
                    onClick={(): void => handleStartEdit(floor)}
                ...
                <button
                  type="button"
                  onClick={(): void => {
                    handleDelete(floor.id).catch(() => undefined);
                  }}
