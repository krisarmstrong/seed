...
export const HARDWARE_RECOMMENDATIONS: {
  cable: { supported: string[]; notSupported: string[]; testCommand: string };
  wifi: { recommended: string[]; limited: string[]; notSupported: string[]; testCommand: string };
  dom: { supported: string[]; module: string };
} = {
  cable: {
