...
export const mockLinkData: Record<string, LinkData> = {
  connected: {
    linkUp: true,
    carrier: true,
    hasIp: true,
...
export const mockSwitchData: { lldp: SwitchData; cdp: SwitchData; noNeighbor: null } = {
  lldp: {
    protocol: 'LLDP',
...
export const mockVlanData: Record<string, VlanData> = {
  tagged: {
    nativeVlan: 1,
...
export const mockDhcpData: Record<string, DhcpData> = {
  dhcpFast: {
...
export const mockDnsData: Record<string, DnsData> = {
  allSuccess: {
    server: '192.168.1.1',
...
export const mockGatewayData: Record<string, GatewayData> = {
  reachable: {
    gateway: '192.168.1.1',
    reachable: true,
    sent: 10,
...
export const mockWiFiData: Record<string, WiFiData> = {
  strongSignal: {
    ssid: 'CorporateWiFi',
...
export const mockCableData: Record<string, CableData> = {
  good: {
    supported: true,
    length: 15,
    status: 'ok',
...
export const mockPublicIpData: Record<string, PublicIpData> = {
  dualStack: {
    ipv4: '203.0.113.42',
    ipv6: '2001:db8::42',
