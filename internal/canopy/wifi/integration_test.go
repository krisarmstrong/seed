...
// Test suite validates integration between WiFi components.
package wifi_test
...
func TestFrequencyChannelConsistency(t *testing.T) {
	...
	tests := []struct {
		...
		// 2.4 GHz
		{1, "2.4GHz"}, {2, "2.4GHz"}, {3, "2.4GHz"}, {4, "2.4GHz"},
		{5, "2.4GHz"}, {6, "2.4GHz"}, {7, "2.4GHz"}, {8, "2.4GHz"},
		{9, "2.4GHz"}, {10, "2.4GHz"}, {11, "2.4GHz"}, {12, "2.4GHz"},
		{13, "2.4GHz"}, {14, "2.4GHz"},

		// 5 GHz UNII-1
		{36, "5GHz"}, {40, "5GHz"}, {44, "5GHz"}, {48, "5GHz"},

		// 5 GHz UNII-2
		{52, "5GHz"}, {56, "5GHz"}, {60, "5GHz"}, {64, "5GHz"},

		// 5 GHz UNII-2E
		{100, "5GHz"}, {104, "5GHz"}, {108, "5GHz"}, {112, "5GHz"},
		{116, "5GHz"}, {120, "5GHz"}, {124, "5GHz"}, {128, "5GHz"},
		{132, "5GHz"}, {136, "5GHz"}, {140, "5GHz"}, {144, "5GHz"},

		// 5 GHz UNII-3
		{149, "5GHz"}, {153, "5GHz"}, {157, "5GHz"}, {161, "5GHz"}, {165, "5GHz"},
	}
